<template>
  <div
    data-pw="song"
    class="relative grow min-w-0 rounded-sm flex items-start py-1"
    :class="rowClass"
  >
    <!-- Album Art -->
    ...
    <div v-if="!compact" class="grow basis-0 pr-0 flex flex-col justify-center min-w-0 -mr-4">
      ...
      <div v-if="song" class="truncate text-[11px] opacity-70">
    ...
    <div
      v-if="compact"
      class="grow basis-0 text-ellipsis overflow-hidden"
      :class="{ 'overflow-hidden': song }"
    >
