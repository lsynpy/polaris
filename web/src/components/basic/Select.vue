<template>
  <Listbox v-model="selected" as="div">
    <ListboxLabel
      v-if="label"
      class="block mb-2 text-sm font-medium leading-6 text-ls-900 dark:text-ds-0"
    >
      {{ label }}
    </ListboxLabel>
    ...
    <div class="relative">
      ...
      >
        <span class="block truncate" v-text="selected?.label" />
      ...
      >
        ...
        >
          ...
          >
            <li
              :class="[
                active ? 'bg-accent-600 text-ls-0 dark:bg-ds-800' : 'text-ls-900 dark:text-ds-0',
            ...
            >
              ...
              <span
                v-if="isSelected"
                :class="[
                  active ? 'text-ls-0 dark:text-ds-0' : 'text-accent-600',
