<template>
  <span
    class="cursor-pointer inline-flex items-center rounded-md whitespace-nowrap text-ls-700 dark:text-ds-300 ring-1 ring-inset ring-ls-200 dark:ring-white/10 hover:bg-ls-100 hover:dark:bg-ds-700"
    :class="sizes[size]"
  >
...
const palette = computed(() => {
  let palette = palettes[_color || 'red'];
  if (props.autoColor) {
