<template>
  <div class="grow overflow-y-auto -mx-4 px-4">
    <Section class="flex flex-col gap-8">
      ...
      <Slider
        v-model="preferences.accentBaseHue"
        label="Accent Hue"
        size="lg"
        :min="0"
        :max="360"
      ...
      <Slider
        v-model="preferences.accentChromaMultiplier"
        label="Accent Saturation"
        size="lg"
        :min="minChromaMultiplier"
        :max="maxChromaMultiplier"
        data-pw="accent-saturation"
        class="w-80"
      >
        <template #fill>
