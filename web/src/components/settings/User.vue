<template>
  <div class="flex flex-col gap-4 2xl:gap-8" data-pw="user">
    <div class="flex flex-col items-start gap-y-4 2xl:flex-row 2xl:items-center justify-between">
      <div class="flex gap-4 items-center">
        <span
          ...
          v-text="'face'"
        />
        <div class="font-medium text-ls-600 dark:text-ds-300" v-text="user.name" />
      </div>
      ...
      <div class="relative flex gap-4 justify-end">
        ...
        <Button
          ...
          data-pw="delete-user"
          :disabled="isSelf"
          @click="users.deleteUser(user.name)"
        />
        ...
        <Transition appear name="slide">
          <div
            ...
            v-on-click-outside="cancelPasswordChange"
          ...
          >
            <form class="relative p-6 flex flex-col gap-4" @submit.prevent="confirmPasswordChange">
              <InputText
                id="new-password"
                v-model="newPassword"
                label="New Password"
    ...
    <div class="flex flex-col gap-2">
      ...
      <span class="italic text-xs text-ls-500 dark:text-ds-400"
        >Grants access to all settings.</span
      >
    </div>
  </div>
</template>
